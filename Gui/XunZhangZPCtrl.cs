...
//		XunZhangZP = XkGameCtrl.GetInstance().XunZhangZP;
	...
	public void CheckLianJiIsShouldStopJiFenPanel()
	{
		...
		if (IsOverPlayerZPXunZhang
		    && (SceneManager.GetActiveScene().buildIndex == (int)(GameLevel.Scene_4) || GameOverCtrl.IsShowGameOver)) {
			//&& (SceneManager.GetActiveScene().buildIndex == XkGameCtrl.TestGameEndLv || GameOverCtrl.IsShowGameOver)) { //test
